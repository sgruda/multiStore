...
function App(props) {
  ...
  const adminToolbarListItem = [
    { id: 'accountList', name: t('account.list.title'), path: '/admin/accountsList', icon: <PeopleIcon/>},
    { id: 'accountCreation', name: t('account.create.title'), path: '/admin/addAccount', icon:  <PersonAddIcon/>},
  ];
